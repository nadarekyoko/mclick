#!/bin/bash
#Script is created by Rey DC Luar Jr.
...
if [[ $vps = "vps" ]]; then
	source="https://raw.githubusercontent.com/nadarekyoko/mclick/master"
else
	source="https://raw.githubusercontent.com/nadarekyoko/mclick/master"
fi
...
read -p "Password: " -e -i Myrina DatabasePass
echo ""
...
read -p " Database Name: " -e -i OCS_PANEL_MCLICK DatabaseName
echo ""
...
echo 'echo -e " ██║ ╚═╝ ██║╚██████╗███████╗██║╚██████╗██║  ██╗ ' >> .bashrc
echo 'echo -e " ╚═╝     ╚═╝ ╚═════╝╚══════╝╚═╝ ╚═════╝╚═╝  ╚═╝ ' >> .bashrc
echo 'echo -e "   ------ Scripted by Myrina Alcantara ------  "' >> .bashrc
echo 'echo -e "welcome to the server $HOSTNAME" | lolcat' >> .bashrc
echo 'echo -e "Script mod by myrina"' >> .bashrc
...
cd /home/vps/public_html
wget https://raw.githubusercontent.com/nadarekyoko/mclick/master/OCSPanel.zip
unzip OCSPanel.zip
rm -f OCSPanel.zip
chown -R www-data:www-data /home/vps/public_html
...
echo "" | tee -a log-install.txt
echo "Auto Script Installer OCS Panels Mod by Myrina"  | tee -a log-install.txt
echo "                        "  | tee -a log-install.txt
echo "" | tee -a log-install.txt
